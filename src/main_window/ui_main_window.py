...
"margin: 0px;")
        ...
        self.verticalLayout_3 = QVBoxLayout(self.encode_message_frame)
        ...
        sizePolicy1.setHeightForWidth(self.encoded_message.sizePolicy().hasHeightForWidth())
        ...
        self.verticalLayout_3.addWidget(self.encoded_message)
